...
import { Bell, Shield, Database, Save, Check } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between py-3 border-b border-border/50 last:border-0">
                            ...
                            <select
                                ...
                                className="px-4 py-2 bg-background border border-border rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-foreground"
                            >
                ...
                <div className="flex justify-end">
                    <Button
                        ...
                        disabled={isSaved}
                    >
                        {isSaved ? "Salvo!" : "Salvar Configuracoes"}
                    </Button>
                </div>
            </form>
        </div>
