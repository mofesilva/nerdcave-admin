            ...
            <div className="bg-primary rounded-md overflow-hidden">
                ...
                >
                    ...
                    <div className={`overflow-hidden transition-all duration-300 pr-3 ${isExpanded ? 'flex-1 opacity-100' : 'w-0 opacity-0'
                        ...
                        <p className="text-sm font-medium truncate whitespace-nowrap text-primary-foreground">
                            {user?.name || 'User'}
                        </p>
                        <p className="text-xs text-primary-foreground/70 truncate whitespace-nowrap">
                            {user?.email}
                        </p>
                    </div>
                </div>
